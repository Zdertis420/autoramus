...
// длине: «Курица» и «Куски курицы» на y=105.2, «Соль» и «Тушёная курица» на
// y=298.8, «Чеснок» и «Чахохбили» на y=347.2. Они различимы прекрасно, и
...
// координату» без неё выглядело бы придиркой.
func TestSharedLineDisjointSpansUnmoved(t *testing.T) {
	...
	want := []struct {
		...
		{105.2, [2]string{"Курица", "Куски курицы"}},
		{298.8, [2]string{"Соль", "Тушёная курица"}},
		{347.2, [2]string{"Чеснок", "Чахохбили"}},
	}
