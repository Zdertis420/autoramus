...
// Геометрия. Эти проверки идут после раскладки: блок, сквозь который идёт
// стрелка, может быть расставлен раскладкой, и до неё его координат нет.
// Выдают только предупреждения — сборку не останавливают.
const (
	...
	// правится (Р2), но и молча не пропускается — стрелка сквозь блок читается
	// как вход или выход этой работы.
