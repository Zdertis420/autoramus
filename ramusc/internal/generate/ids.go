...
// lines раздаёт номера координатных линий одного сектора.
//
...
// на двух линиях). Общих линий между разными стрелками эта версия не заводит:
// разведение по каналам вынесено за границы фичи.
type lines struct {
	counters *counters
